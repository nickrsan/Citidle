...
export const RESEARCH_TREE = [
    // ── Zoning Unlocks ──
    {
        id: 'unlock_residential',
        name: 'Residential Zoning',
        description: 'Unlock residential zone placement.',
        maxLevel: 1,
        baseCost: 0,
        costScale: 1,
        requires: {},
        effects: [{ variable: 'unlock_residential', operation: 'set', value: true }],
        category: 'unlock',
    },
    {
        id: 'unlock_commercial',
        name: 'Commercial Zoning',
        description: 'Unlock commercial zone placement.',
        maxLevel: 1,
        baseCost: 50,
        costScale: 1,
        requires: { unlock_residential: 1 },
        effects: [{ variable: 'unlock_commercial', operation: 'set', value: true }],
        category: 'unlock',
    },
    {
        id: 'unlock_industrial',
        name: 'Industrial Zoning',
        description: 'Unlock industrial zone placement.',
        maxLevel: 1,
        baseCost: 100,
        costScale: 1,
        requires: { unlock_commercial: 1 },
        effects: [{ variable: 'unlock_industrial', operation: 'set', value: true }],
        category: 'unlock',
    },
    ...
    // ── Spread Rate ──
    {
        id: 'spread_rate',
        name: 'Urban Sprawl',
        description: 'Increase zone spread chance by 25% per level.',
        maxLevel: 10,
        baseCost: 80,
        costScale: 1.8,
        requires: { unlock_residential: 1 },
    ...
    // ── Efficiency ──
    {
        ...
        description: 'Residential output ×1.15 per level.',
        maxLevel: 10,
        baseCost: 150,
        costScale: 2.0,
        requires: { density_residential: 2 },
        effects: [{ variable: 'efficiency_residential', operation: 'multiply', value: 1.15 }],
        category: 'efficiency',
    },
    {
        id: 'efficiency_commercial',
        name: 'Commercial Efficiency',
        description: 'Commercial output ×1.15 per level.',
        maxLevel: 10,
        baseCost: 200,
        costScale: 2.0,
        requires: { density_commercial: 2 },
        effects: [{ variable: 'efficiency_commercial', operation: 'multiply', value: 1.15 }],
        category: 'efficiency',
    },
    {
        id: 'efficiency_industrial',
        name: 'Industrial Efficiency',
        description: 'Industrial output ×1.15 per level.',
        maxLevel: 10,
        baseCost: 250,
        costScale: 2.0,
        requires: { density_industrial: 2 },
        effects: [{ variable: 'efficiency_industrial', operation: 'multiply', value: 1.15 }],
        category: 'efficiency',
    },
    ...
    // ── Tick Speed ──
    {
        ...
        costScale: 2.5,
        requires: { unlock_industrial: 1 },
        effects: [{ variable: 'tick_speed_multiplier', operation: 'multiply', value: 0.92 }],
        category: 'economy',
    },
